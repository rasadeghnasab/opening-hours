...
//            $content = $response->dump()->content();
//            dump($content);
//            dd($response->dump());
//            dump('result', strtotime($response->json('next')), $response->json('data'), $response->json('next'));
//            dump('expected', $test['expected'], strtotime($test['expected']));
//            dump('-------------');
