...
Route::get('open_hours/stations/{station}/state', [OpenHoursController::class, 'check']);
Route::get('open_hours/stations/{station}/state/nextChange', [OpenHoursController::class, 'nextStateChange']);
